...
config :elixir_formula, Scrapers.Scheduler,
  jobs: [
    ...
    {"15 * * * *", {Scrapers.PersonalBlogs.Bigargone, :run, []}},
    {"16 * * * *", {Scrapers.PersonalBlogs.ElixirLang, :run, []}},
    {"17 * * * *", {Scrapers.PersonalBlogs.Pentacent, :run, []}},
    ...
    {"24 * * * *", {Scrapers.Podcasts.Changelog, :run, []}},
    {"25 * * * *", {Scrapers.Podcasts.ElixirMix, :run, []}},
    {"26 * * * *", {Scrapers.Podcasts.ElixirWizards, :run, []}},
    {"27 * * * *", {Scrapers.Podcasts.ThinkingElixir, :run, []}},
    {"28 * * * *", {Scrapers.PublishingPlatforms.DevTo, :run, []}}
  ]
