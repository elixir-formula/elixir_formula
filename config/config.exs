...
config :elixir_formula, Scrapers.Scheduler,
  jobs: [
    ...
    {"11 * * * *", {Scrapers.CompaniesBlogs.Smartlogic, :run, []}},
    {"12 * * * *", {Scrapers.CompaniesBlogs.Thoughtbot, :run, []}},
    {"13 * * * *", {Scrapers.PersonalBlogs.Bigargone, :run, []}},
    {"14 * * * *", {Scrapers.PersonalBlogs.Changelog, :run, []}},
    ...
    {"20 * * * *", {Scrapers.PersonalBlogs.TheGreatCodeAdventure, :run, []}},
    {"21 * * * *", {Scrapers.PersonalBlogs.TodayILearned, :run, []}},
    {"22 * * * *", {Scrapers.Podcasts.ElixirMix, :run, []}},
    {"23 * * * *", {Scrapers.Podcasts.ElixirWizards, :run, []}},
    {"24 * * * *", {Scrapers.Podcasts.ThinkingElixir, :run, []}},
    {"25 * * * *", {Scrapers.PublishingPlatforms.DevTo, :run, []}}
  ]
